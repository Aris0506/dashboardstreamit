...
#menyiapkan DataFrame yang akan digunakan untuk membuat visualisasi
...
#exploratory Data Analysis, all_df memiliki dua kolom yang bertipe datetime, yaitu order_date dan delivery_date.
...
# DataFrame yang telah difilter (main_df) inilah yang digunakan untuk menghasilkan berbagai DataFrame
#yang dibutuhkan untuk membuat visualisasi data. Proses ini tentunya dilakukan dengan memanggil helper function
...
# Tahap berikutnya adalah menambahkan informasi terkait daily orders pada dashboard yang akan kita buat.
# Pada proyek ini, kita akan menampilkan tiga informasi terkait daily orders, yaitu jumlah order harian
...
# yang ditampilkan menggunakan layout columns(). Di lain sisi, informasi tentang jumlah order harian ditampilkan
...
# kita tampilkan pada dashboard tersebut ialah terkait demografi pelanggan yang kita miliki. 
